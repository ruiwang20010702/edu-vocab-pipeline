...
class ReviewService:
    ...
    def approve(self, session: Session, review_id: int, reviewer: str, note: Optional[str] = None) -> ReviewItem:
        """通过审核."""
    ...
    def regenerate(self, session: Session, review_id: int, reviewer: str) -> dict:
        """触发重新生成（≤3次）.
